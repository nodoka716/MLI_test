     ...
     + ( HT344 .EQ. 1 .AND. T__TD .LT. F__TD ) ) THEN
      ...
      CALL LOADQ_C1A0_1657040543
       ...
       END
       SUBROUTINE OUT0018
       !DEC$ ATTRIBUTES DLLEXPORT::OUT0018
       RETURN
       END
       SUBROUTINE OUT0019
       !DEC$ ATTRIBUTES DLLEXPORT::OUT0019
       RETURN
       END
       SUBROUTINE TDHTR
       use sf_interfaces
     ...
     +'Heater[HEATER1509]::344'
      ...
      RETURN
      END
      RECURSIVE SUBROUTINE LOADQ_C1A0_1657040543
     ...
     + A(1) )
      ...
      END
       ...
       ELSE IF(MODNO .EQ.        17)   THEN
                CALL VA00017
       ELSE IF(MODNO .EQ.        18)   THEN
                CALL VA00018
       ELSE IF(MODNO .EQ.        19)   THEN
                CALL VA00019
       END IF
       RETURN
       END
